...
App.controller('homeController', function ($scope, $rootScope) {
    ...
    if (($scope.country != null || $scope.country != undefined) && $scope.country.length > 0) {
        if (!$scope.country.indexOf(new Date().getFullYear() > -1))
            $rootScope.infoWarn.log("Update public holiday list in settings.");
    }
